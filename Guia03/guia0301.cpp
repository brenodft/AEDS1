/*
Guia0301 - v0.0. - 15 / 08 / 2023 Author: Breno Pires Santos
Para compilar em uma janela de comandos (terminal):
No Linux : g++ -o Guia0301 ./Guia0301.cpp No Windows: g++ -o Guia0301 Guia0301.cpp
Para executar em uma janela de comandos (terminal):
No Linux : ./Guia0301 No Windows: Guia0301
*/
...
// world->set ( 4, 4, VWALL ); // world->set ( 4, 4, HWALL );
// colocar um marcador no mundo world->set ( 4, 4, BEEPER );
// salvar a configuracao atual do mundo world->save( fileName );
} // decorateWorld ( )
/**
Classe para definir robo particular (MyRobot), a partir do modelo generico (Robot)
...
world->create ( "" ); // criar o mundo decorateWorld ( "Guia0301.txt" );
world->show ( );
...
---------------------------------------------- notas / observacoes / comentarios ---------------------------------------------- previsao de testes
